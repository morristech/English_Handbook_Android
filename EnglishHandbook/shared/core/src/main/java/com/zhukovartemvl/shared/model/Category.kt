...
data class IrregularVerbs(val key: String, val title: String) : Category(5)
data class Dictionary(val key: String, val title: String) : Category(6)
data class Links(val key: String, val title: String) : Category(7)
data class Title(val key: String, val title: String) : Category(8)
